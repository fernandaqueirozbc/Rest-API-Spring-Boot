...
public class GravaTeatro {
    ...
    public static void gravaRegistroList(List<Teatro> teatro, String nomeArq, Boolean txt) {
        String header = "";
        String delimitador = "";
        String trailer = "";
        Integer cont = 0;
        ...
        for (Teatro t : teatro) {
            saida.format("%5d%s%20s%s%20s\n",
                    t.getCodPeca(), delimitador, t.getNomePeca(), delimitador, t.getHorario(), t.getValorIngresso());
            cont++;
        }
